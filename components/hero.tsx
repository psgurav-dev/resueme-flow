  ...
  return (
    <div className="w-full -top-16 relative">
      ...
      <div className="flex flex-col gap-y-4 items-center justify-center h-screen z-10 relative px-6 ">
        <h1 className="font-bold text-center font-bricolage max-w-4xl text-gray-200 drop-shadow-2xl text-3xl md:text-4xl lg:text-6xl font-semibold max-w-5xl mx-auto text-center  relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800">Convert Your Resume to a Professional Portfolio</h1>
        <h4 className="font-manrope text-black text-center px-8 mb-8">Turn Your Resume Into a Stunning Portfolio Website</h4>
